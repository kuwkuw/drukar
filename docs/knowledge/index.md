...
*why* and the *intent*: the business bets behind the product and the technical features that
implement them, each as a durable, linkable record. It's the home for decisions and ideas that
...
_Next ids: business `B-004`, feature `F-005`._
